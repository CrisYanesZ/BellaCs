...
<nav id="navbar-auto-hidden" style="background-color:#EF0D5F;">
        <div class="row hidden-xs">
            <div class="col-xs-4">
            <!--img src="nuevologo.png" width="80" height="80"-->
              <p class="text-navbar tittles-pages-logo" style="font-family: 'Dancing Script', cursive;font-size: 30px;"><i class="fa fa-store"></i>Bella Cosmetics</p>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">Bella Cosmetics</h3>
