<p class="lead">
    Lorem ipsum dolor sit amet, perferendis sunt. 
</p>
<ul class="breadcrumb" style="margin-bottom: 5px;">
    <li>
        <a href="configAdmin.php?view=provider" style="color:#DB12C6">
            <i class="fa fa-plus-circle" aria-hidden="true" style="color:#DB12C6"></i> &nbsp; Nuevo Proveedor
        </a>
    </li>
    <li>
        <a href="configAdmin.php?view=providerlist" style="color:#DB12C6"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Proveedores de la tienda</a>
    </li>
</ul>
<div class="container">
	<div class="row">
		<div class="col-xs-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading text-center" style="background-color:#EF0D5F"><h4>Proveedores de la tienda</h4></div>
                  ...
                  <table class="table table-striped table-hover">
                      	...
                      	<tbody>
							...
							<tr>
								...
								<td class="text-center"><?php echo $prov['RTNProveedor']; ?></td>
								...
								<td class="text-center">
	                        		<a href="configAdmin.php?view=providerinfo&code=<?php echo $prov['RTNProveedor']; ?>" class="btn btn-raised btn-xs btn-success">Actualizar</a>
	                        	</td>
	                        	<td class="text-center">
	                        		<form action="process/delprove.php" method="POST" class="FormCatElec" data-form="delete">
	                        			<input type="hidden" name="nit-prove" value="<?php echo $prov['RTNProveedor']; ?>">
