<p class="lead">
   Aqui podremos modificar nuestra cuenta de usuario.
<div class="container">
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                <h3 class="text-info text-center" style="color:#DB12C6">Actualizar cuenta</h3>
                <?php
                ...
                <form action="./process/updateAdmin.php" method="POST" role="form" class="FormCatElec" data-form="update">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                            	<p class="text-primary text-center" style="padding-top: 20px;" style="color:#DB1225">No es necesario actualizar la contraseña, sin embargo si desea hacerlo debe de ingresar una nueva contraseña y volver a ingresarla</p>
                            </div>
                    ...
                    <p class="text-center"><button type="submit" class="btn btn-primary btn-raised" style="background-color:#DB1225">Actualizar cuenta</button></p>
                </form>
            </div>
        </div>
    </div>
