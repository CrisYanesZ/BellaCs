<p class="lead">
En este apartado podemos agregar nuevos productos o visualizar los productos ya existentes.
</p>
<ul class="breadcrumb" style="margin-bottom: 5px;">
    <li>
        <a href="configAdmin.php?view=product" style="color:#DB12C6">
            <i class="fa fa-plus-circle" aria-hidden="true"  style="color:#DB12C6"></i> &nbsp; Nuevo producto
        </a>
    </li>
    <li>
        <a href="configAdmin.php?view=productlist" style="color:#DB12C6"><i class="fa fa-list-ol" aria-hidden="true"  style="color:#DB12C6"></i> &nbsp; Productos en tienda</a>
    </li>
</ul>
<div class="container">
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                <h3 class="text-primary text-center" style="color:#DB12C6">Agregar un producto a la tienda</h3>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                                ...
                                <select class="form-control" name="prod-codigoP">
                                    <?php
                                        ...
                                        while($provc=mysqli_fetch_array($proveedoresc, MYSQLI_ASSOC)){
                                            echo '<option value="'.$provc['RTNProveedor'].'">'.$provc['NombreProveedor'].'</option>';
                                        }
                                    ?>
                                </select>
                              </div>
                            ...
                            <div class="col-xs-12">
                                ...
                                <p class="text-center text-primary" style="color:#DB12C6">
                ...
                <p class="text-center"><button type="submit" class="btn btn-primary btn-raised" style="background-color:#EF0D5F">Agregar a la tienda</button></p>
                </form>
            </div>
        </div>     
    </div>
