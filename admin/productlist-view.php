...
<ul class="breadcrumb" style="margin-bottom: 5px;">
    <li>
        <a href="configAdmin.php?view=product" style="color:#EF0D5F">
            <i class="fa fa-plus-circle" aria-hidden="true" style="color:#EF0D5F"></i> &nbsp; Nuevo producto
        </a>
    </li>
    <li>
        <a href="configAdmin.php?view=productlist" style="color:#EF0D5F"><i class="fa fa-list-ol" aria-hidden="true"></i> &nbsp; Productos en tienda</a>
    </li>
</ul>
<div class="container">
	<div class="row">
		<div class="col-xs-12">
            ...
            <div class="panel panel-info">
              <div class="panel-heading text-center" style="background-color:#EF0D5F"><h4>Productos en tienda</h4></div>
                  ...
                  <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                        	...
                        	<td class="text-center">
                        		<?php
                        			$prov=ejecutarSQL::consultar("SELECT NombreProveedor FROM proveedor WHERE RTNProveedor='".$prod['RTNProveedor']."'");
