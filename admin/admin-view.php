<p class="lead">
En este apartado podremos ingresar  nuevos administradores del sistema.
</p>
	...
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                <h3 class="text-info text-center" style="color:#DB12C6">Agregar un nuevo administrador</h3>
                <form action="process/regAdmin.php" method="POST" role="form" class="FormCatElec" data-form="save">
                    ...
                    <p class="text-center"><button type="submit" class="btn btn-primary btn-raised" style="background-color:#EF0D5F">Agregar administrador</button></p>
                </form>
            </div>
        </div>
    </div>
