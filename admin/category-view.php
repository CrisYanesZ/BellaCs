<p class="lead">
En este apartado podemos agregar nuevas categorias  o visualizar las categorias ya existentes.
</p>
	...
	<div class="row">
        <div class="col-xs-12">
            <div class="container-form-admin">
                <h3 class="text-info text-center" style="color:#DB12C6">Agregar nueva categoría</h3>
                <form action="process/regcategori.php" method="POST" class="FormCatElec" data-form="save">
                    ...
                    <p class="text-center"><button type="submit" class="btn btn-primary btn-raised" style="background-color:#EF0D5F">Agregar categoría</button></p>
                </form>
            </div>
        </div>
    </div>
